...
Dependencies: LibStub, AceLibrary, Babble-2.2, GratuityLib, RangeCheck-2.0, DewdropLib(optional), Waterfall-1.0(optional), SharedMediaLib(optional)
...
local rc = LibStub:GetLibrary("RangeCheck-2.0");
